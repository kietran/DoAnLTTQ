    ...
    namespace DoAnLTTQ1
    {
        ...
        internal partial class MainCalculatorControl
        {
            ...
            static public void turnOnInvalidExpressionMode(string errorMessage)
            {
                ...
                currentCursor = form1.InputText.CurrentCursorPosition;
                form1.OutputText.Text = "Press AC/DEL to break";
                form1.InputText.Text = errorMessage;     
            
                form1.onInvalidExpressionMode = true;
                form1.InputText.disableCaret();
            }
            static public void turnOffInvalidExpressionMode()
            {
                form1.InputText.Text = currentInputText;
                form1.InputText.CurrentCursorPosition = currentCursor;
                form1.OutputText.Text = string.Empty;

                form1.onInvalidExpressionMode = false;
                form1.InputText.enableCaret();
            }
        ...
        internal partial class MainCalculatorControl
        {
            ...
            static public void cachesNewMemory()
            {
                ...
                {
                    //pop the first
                    for (int i = 0; i < form1.maxMemoryCachesSize-1; i++)
                    {
                        form1.memoryCaches[i] = form1.memoryCaches[i + 1];
                    }
                    form1.memoryCaches[form1.maxMemoryCachesSize-1] = new Tuple<string, string>(form1.InputText.Text, form1.OutputText.Text);
